...
tiny_yolo_graph_file= '/home/pi/Desktop/Roshan9/esap-lab-9/yolo/graph'
#TODO: Assign this to the name of the pretrained yolo graph file. 
    ...
    for obj_index in range(len(filtered_objects)):
        ...
        #count = 0
         ...
         #   crop_img = source_image[box_top: box_bottom, box_left: box_right]
          #  imgname = "/home/pi/Desktop/Roshan9/esap-lab-9/task7/task7_images/" +str(count) +".png"
           # count = count + 1
            #print(imgname)
...
def main():
    ...
    while True:
        ...
        input_image = (input_image*(2.0/255.0))# TODO: Scale values between 0 and 255
    ...
    #print('Found this many objects in the image: ' + str(len(filtered_objects)))
        ...
        # calculate box (left, top) and (right, bottom) coordinates
            ...
            #for obj_index in range(len(filtered_objs)):
                    crop_img = display_image[box_top: box_bottom, box_left: box_right]
                    if(count == 5):
                        count = 0
                    imgname = "/home/pi/Desktop/Roshan9/esap-lab-9/task7/task7_images/" +str(count) +".png"
                    count = count + 1
